...
public class ProblemOfUsingDirectSQLTest {
     ...
     *  2. SQL에 의존하여 개발
     *  3. 패러다임 불울치(상속, 연관관계, 객체 그래프 탐색, 방향성)
     *  4. 동일성 보장 문제
    * */

    /* 설명. 1. 데이터 변환, SQL 작성, JDBC API 코드 등의 중복 작성(개발시간 증가, 유지보수성 저하) */
    ...
    * */
    ...
    /* 설명 4. 동일성 보장 문제 */
    @DisplayName("조회한 두 개의 행을 탐은 객체의 동일성 비교 테스트")
    @Test
